...
public class LibVLC {
     ...
     *
     * @return The media list object being followed   /return mMediaList
     */
    ...
    /**
     * Gets current movie's total time length in ms. (useful)
     * 获取所播放的视频总时长
